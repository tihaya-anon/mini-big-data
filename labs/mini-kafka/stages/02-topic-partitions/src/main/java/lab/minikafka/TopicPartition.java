...
/**
 * Identifies one ordered log inside a topic.
 *
 * <p>Kafka ordering is scoped to a topic partition, not to the whole topic. Keeping this as one
 * value object makes that boundary explicit in maps and tests.
 */
